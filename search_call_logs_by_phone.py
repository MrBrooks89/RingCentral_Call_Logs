...
parser.add_argument(
    "--phone_number", help="Phone number to filter call logs for.", required=True
)
parser.add_argument(
    "--date_from",
...
parser.add_argument(
    "--view",
    help="Level of detail for the call log records.",
...
while True:
    ...
    for record in records:
        ...
        from_obj = getattr(
            record, "from_", record.get("from_") if isinstance(record, dict) else None
        )
